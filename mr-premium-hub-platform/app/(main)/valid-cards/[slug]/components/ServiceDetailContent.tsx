...
> = {
  ...
  "gift-card-visa": {
    features: [
      "دارای اعتبار مشخص - در مبالغ مختلف قابل ارائه می‌باشد",
      "عدم قابلیت شارژ مجدد - شارژ گیفت کارت ویزا، امکان پذیر نمی‌باشد",
      "دارای اعتبار 7 ماهه - این کارت دارای 7 ماه اعتبار بوده و بعد از آن می‌توانید نسبت به تهیه کارت جدید اقدام کنید",
      "پشتیبانی مستر پرمینیوم هاب - پشتیبانی مستر پرمینیوم هاب ۲۴ ساعته به شما کمک خواهد کرد",
    ],
    steps: ["ثبت درخواست", "بررسی و تایید", "انجام خدمت", "تایید نهایی"],
    description:
      "گیفت کارت ویزا، کارت هدیه‌ای است که با مبلغ مشخصی صادر می‌شود و شما با خرید هر یک از آن‌ها می‌توانید در سایت‌های خارجی استفاده کرده و به خرید کالا یا خدمات آن‌ها اقدام کنید. اکثر سایت‌های دنیا گیفت کارت ویزا را می‌پذیرند و این کارت‌ها قابلیت تعویض در صورت سرقت یا گم شدن را دارند. این کارت صرفاً برای پرداخت‌های آنلاین طراحی شده و امکان برداشت از دستگاه‌های ATM و کارتخوان وجود ندارد.",
  },
  amazon: {
    features: [
      "خرید از آمازون - برای خرید کالا و خدمات از بزرگ‌ترین فروشگاه آنلاین جهان",
      "پذیرندگی بین‌المللی - قابل استفاده در تمام کشورهایی که آمازون فعالیت دارد",
    ...
    steps: ["ثبت درخواست", "بررسی و تایید", "انجام خدمت", "تایید نهایی"],
    description:
      "آمازون (Amazon) بزرگ‌ترین فروشگاه آنلاین جهان است و مجموعه‌ای گسترده از کالاها و خدمات جذاب را ارائه می‌دهد؛ اما متأسفانه در ایران فعالیت مستقیم ندارد و کاربران ایرانی نمی‌توانند به‌طور مستقیم از آن خرید کنند. مستر پرمینیوم هاب امکان خرید کالا از آمازون را برای شما فراهم می‌کند، اما اگر می‌خواهید خودتان تجربه خرید از آمازون را داشته باشید، گیفت کارت آمازون بهترین گزینه است.\n\nبا استفاده از گیفت کارت آمازون می‌توانید به راحتی تمامی محصولات فیزیکی و دیجیتالی این فروشگاه را خریداری کنید. توجه داشته باشید که برای جلوگیری از بلاک شدن کارت، خرید خود را با آی‌پی غیر ایرانی انجام دهید.",
  },
  apple: {
    features: [
      "خرید از اپ استور - برای خرید برنامه‌ها و بازی‌ها از اپ استور اپل استفاده کنید",
      "سازگار با همه دستگاه‌ها - قابل استفاده در iPhone، iPad، Mac و Apple TV",
      "تحویل فوری - دریافت کد گیفت کارت بلافاصله پس از خرید",
      "خدمات آیتونز - دسترسی به موسیقی، فیلم و سایر محتوای آیتونز",
    ],
    steps: ["ثبت درخواست", "بررسی و تایید", "انجام خدمت", "تایید نهایی"],
    description:
      "اگر از محصولات شرکت اپل استفاده می‌کنید، می‌دانید که برای نصب برنامه‌ها باید به اپ استور مراجعه کنید و احتمالاً با خدمات متنوع آیتونز هم آشنایی دارید. متأسفانه بسیاری از برنامه‌ها و خدمات آیتونز رایگان نیستند و کاربران ایرانی به دلیل محدودیت‌ها دسترسی مستقیم ندارند.\n\nبا خرید گیفت کارت اپل، می‌توانید حساب خود را شارژ کرده و به‌صورت نامحدود از برنامه‌ها و امکانات اپ استور و آیتونز استفاده کنید. با داشتن گیفت کارت اپل دیگر نیازی به وارد کردن شماره ویزا یا مسترکارت خود نخواهید داشت.",
  },
  spotify: {
    features: [
      "بدون تبلیغات - شنیدن موسیقی‌ها و پادکست‌های مورد علاقه بدون هیچ تبلیغی",
      "دسترسی به میلیون‌ها موسیقی - دسترسی نامحدود به کتابخانه عظیم موسیقی و پادکست اسپاتیفای",
      "پلی‌لیست نامحدود - امکان ایجاد پلی‌لیست به میزان نامحدود و ذخیره موسیقی‌ها",
      "پخش آفلاین - امکان دانلود و پخش موسیقی‌ها به صورت آفلاین",
    ],
    steps: ["ثبت درخواست", "بررسی و تایید", "انجام خدمت", "تایید نهایی"],
    description:
      "اسپاتیفای (Spotify) بزرگ‌ترین پلتفرم پخش موسیقی و پادکست است و میلیون‌ها کاربر در سراسر جهان از آن روی سیستم‌عامل‌های مختلف مانند ویندوز، مک، اندروید و… استفاده می‌کنند.\n\nنسخه رایگان اسپاتیفای محدودیت‌های زیادی دارد و بسیاری کاربران را به خرید اکانت پرمیوم ترغیب می‌کند. با خرید گیفت کارت اسپاتیفای می‌توانید به راحتی اکانت خود را پرمیوم کنید و از تمامی محدودیت‌ها آزاد شوید.",
  },
  netflix: {
    features: [
      "دسترسی به محتوای نامحدود - تماشای میلیون‌ها فیلم و سریال روز دنیا بدون محدودیت",
      "پذیرندگی بین‌المللی - قابل استفاده در تمام کشورهایی که نتفلیکس فعالیت دارد",
      "تحویل فوری - بلافاصله پس از پرداخت از طریق ایمیل تحویل داده می‌شود",
      "امن و مطمئن - خرید امن با ضمانت اصالت و کیفیت از مستر پرمینیوم هاب",
    ],
    steps: ["ثبت درخواست", "بررسی و تایید", "انجام خدمت", "تایید نهایی"],
    description:
      "اگر اهل تماشای فیلم و سریال هستید، حتماً نتفلیکس (Netflix) را می‌شناسید! این پلتفرم بزرگ جهانی، امکان دسترسی نامحدود به انواع برنامه‌های تلویزیونی و محتوای سرگرم‌کننده را در اختیار کاربران خود قرار می‌دهد.\n\nبا تهیه اکانت پرمیوم نتفلیکس می‌توانید از تماشای میلیون‌ها فیلم و سریال روز دنیا لذت ببرید. با خرید گیفت کارت نتفلیکس، بدون نیاز به حساب بانکی بین‌المللی، اکانت خود را شارژ کرده و وارد دنیای سرگرمی شوید.",
  },
  "credit-card": {
    features: [
