...
const plans = [
  {
    id: "pro",
    title: "پلن حرفه‌ای",
    titleEn: "VPS Netherlands Professional",
    subtitle: "سرور مجازی هلند حرفه‌ای",
    price: "25",
    period: "ماهانه",
    features: [
      "۲ هسته پردازنده",
  ...
  },
  {
    id: "basic",
    title: "پلن پایه",
    titleEn: "VPS Netherlands Basic",
    subtitle: "سرور مجازی هلند پایه",
    price: "15",
    period: "ماهانه",
    features: [
      "۱ هسته پردازنده",
...
interface VPSNetherlandsPlansProps {
  initialProducts?: ShopProduct[];
}

export default function VPSNetherlandsPlans({
  initialProducts = [],
}: VPSNetherlandsPlansProps) {
  ...
  return (
    <section
      aria-labelledby="vps-netherlands-plans-heading"
      className="rounded-xl shadow-sm border border-gray-100 p-6 md:p-8 mb-6"
    >
      <h2
        id="vps-netherlands-plans-heading"
        className="text-lg md:text-xl font-bold text-gray-900 mb-2 text-center"
      >
        ویژگی‌ها و امکانات پلن‌های سرور مجازی هلند
      </h2>
      <p className="text-sm text-gray-600 mb-6 text-center leading-relaxed">
        پلن‌های مختلف سرور مجازی هلند برای نیازهای مختلف شما
      </p>
