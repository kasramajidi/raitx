  ...
  "international-sim": [
    {
      ...
      answer:
        "سیم‌کارت‌های بین‌المللی امکان استفاده از خدمات تلفن همراه در کشورهای مختلف را فراهم می‌کنند. این سیم‌کارت‌ها معمولاً پوشش چندین کشور را دارند و امکان برقراری تماس، ارسال پیامک و استفاده از اینترنت را در مقصد سفر در اختیار کاربران قرار می‌دهند.",
    },
    {
      question: "آیا نیاز به تنظیمات خاصی برای استفاده از این سیم کارت‌ها دارم؟",
      answer:
        "خیر، بیشتر سیم‌کارت‌های بین‌المللی به‌صورت خودکار فعال و تنظیم می‌شوند. کافی است سیم‌کارت را در گوشی قرار دهید و منتظر اتصال به شبکه بمانید.",
    },
    {
      question: "آیا می‌توانم سیم کارت را قبل از سفر شارژ کنم؟",
      answer:
        "بله، این امکان وجود دارد که پیش از سفر، سیم‌کارت بین‌المللی خود را از طریق سرویس‌های آنلاین شارژ کنید تا در مقصد بدون هیچ‌گونه مشکل از خدمات آن استفاده نمایید.",
    },
    {
      question: "مدت زمان اعتبار سیم کارت‌ها چقدر است؟",
      answer:
        "مدت زمان اعتبار سیم‌کارت بسته به نوع آن متفاوت است و معمولاً بین ۳۰ روز تا یک سال اعتبار دارد.",
    },
    {
      question: "آیا امکان استفاده از اینترنت پرسرعت وجود دارد؟",
      answer:
        "بله، اکثر سیم کارت‌های بین المللی دسترسی به اینترنت ۴G و ۵G را در کشورهای پشتیبانی شده فراهم می‌کنند.",
    },
    {
      question: "در صورت مشکل با سیم کارت چه کنم؟",
      answer:
        "در صورت بروز هر گونه مشکل می‌توانید با پشتیبانی ۲۴ ساعته ما تماس بگیرید تا مشکل شما در سریع‌ترین زمان ممکن حل شود.",
    },
  ],
};
...
export default function ServiceFAQ({ service }: ServiceFAQProps) {
  ...
  const title =
    service.id === "international-sim"
      ? "سوالات متداول درباره پرداخت ارزی"
