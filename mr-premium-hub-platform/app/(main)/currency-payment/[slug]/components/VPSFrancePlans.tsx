...
const plans = [
  {
    id: "pro",
    title: "پلن حرفه‌ای",
    titleEn: "VPS France Professional",
    subtitle: "سرور مجازی فرانسه حرفه‌ای",
    price: "25",
    period: "ماهانه",
    features: [
      "۴ هسته پردازنده",
  ...
  },
  {
    id: "basic",
    title: "پلن پایه",
    titleEn: "VPS France Basic",
    subtitle: "سرور مجازی فرانسه پایه",
    price: "15",
    period: "ماهانه",
    features: [
      "۲ هسته پردازنده",
...
interface VPSFrancePlansProps {
  initialProducts?: ShopProduct[];
}

export default function VPSFrancePlans({
  initialProducts = [],
}: VPSFrancePlansProps) {
  ...
  return (
    <section
      aria-labelledby="vps-france-plans-heading"
      className="rounded-xl shadow-sm border border-gray-100 p-6 md:p-8 mb-6"
    >
      <h2
        id="vps-france-plans-heading"
        className="text-lg md:text-xl font-bold text-gray-900 mb-2 text-center"
      >
        خصوصیات سرور مجازی فرانسه یک ماهه
      </h2>
      <p className="text-sm text-gray-600 mb-6 text-center leading-relaxed">
        پلن‌های مختلف سرور مجازی فرانسه برای نیازهای مختلف شما
      </p>
